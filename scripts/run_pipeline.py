...
def main():
    ...
    if args.cfg_file is not None:
        ...
        cfg_dict_dataset, cfg_dict_pipeline, cfg_dict_model = _ml3d.utils.Config.merge_cfg_file(cfg, args, extra_dict)
        ...
        if (args.pipeline and args.model and args.dataset) is None:
            raise ValueError("please specify pipeline, model, and dataset " + if no cfg_file given")
        ...
        cfg_dict_dataset, cfg_dict_pipeline, cfg_dict_model = _ml3d.utils.Config.merge_module_cfg_file(args, extra_dict)
